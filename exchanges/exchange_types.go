...
type CurrencyPair struct {
	...
	RequestFormat config.CurrencyPairFormatConfig `json:"requestFormat,omitempty"`
	ConfigFormat  config.CurrencyPairFormatConfig `json:"configFormat,omitempty"`
}
...
type CurrencyPairs struct {
	...
	Spot       CurrencyPair      `json:"spot,omitempty"` // for futures only exchanges like Bitmex
	Futures    CurrencyPair      `json:"futures,omitempty"`
}
