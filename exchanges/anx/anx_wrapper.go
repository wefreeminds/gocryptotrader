...
func (a *ANX) UpdateTicker(p pair.CurrencyPair, assetType assets.AssetType) (ticker.Price, error) {
	...
	tick, err := a.GetTicker(exchange.FormatExchangeCurrency(a.GetName(), p, assetType).String())
	if err != nil {
...
func (a *ANX) UpdateOrderbook(p pair.CurrencyPair, assetType assets.AssetType) (orderbook.Base, error) {
	...
	orderbookNew, err := a.GetDepth(exchange.FormatExchangeCurrency(a.GetName(), p, assetType).String())
	if err != nil {
